				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 signup_section">
					<form action="<%=request.getContextPath()%>/signup"
						...
						<div class="error" id="user-error">
							<img src="css/images/icon_error.svg" alt="error_icon" /> All
							fields are required!
						</div>
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="login_check">
							<label class="form-check-label" for="login_check">Receive
								our weekly newsletter and other occasional updates</label>
						</div>
						...
						<p id="privacyTerms" class="small_text">
							By signing up, you agree to our <a href="#">terms of use</a>, <a
								href="#">Privacy Policy</a>, <a href="#">and cookie policy</a>.
						</p>
					</form>
				</div>
			</div>
