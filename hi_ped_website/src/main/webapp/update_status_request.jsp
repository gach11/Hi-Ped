					...
					<form method="post" action="update-process.jsp">
						...
						<div class="form-row">
							<input type="text" class="form-control" name="appointmentId"
								id=appointmentId
								value="<%=resultSet.getString("appointmentId") %>"
								placeholder="ID">
						</div>
						<div class="form-row">
						...
						<div class="form-row">
							<input type="text" class="form-control" name="concern"
								id="concern" value="<%=resultSet.getString("concern") %>"
								placeholder="Concern">
						</div>
						<div class="form-row">
							<input type="text" class="form-control" name="guardian"
								id="guardian" value="<%=resultSet.getString("guardian") %>"
								placeholder="Guardian">
						</div>
						<div class="form-row">
							<input type="text" class="form-control" name="datetime"
								id="datetime" value="<%=resultSet.getString("datetime") %>"
						...
						<div class="form-row">
							<input type="text" class="form-control" name="status"
								value="<%=resultSet.getString("status") %>" placeholder="status">
						</div>
