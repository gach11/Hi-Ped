...
String sql="UPDATE appointmentdata set appointment_id=?,fullname=?,concern=?,datetime=?,guardian=?, status=? where appointment_id="+appointment_id;
...
<body>
	...
	<div class="card">
		<div
			style="border-radius: 200px; height: 200px; width: 200px; background: #C2E2FF; margin: 0 auto;">
		...
		<br> <a type="button" class="btn btn-light"
			href="doctor_appointment_request.jsp">OK</a>
	</div>
