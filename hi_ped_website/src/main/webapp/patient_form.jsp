...
<!-- корректное отображение на мобильных устройствах, отмена масштабирования -->
			...
			<div class="row">
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 signup_section">
					...
					<form action="<%=request.getContextPath()%>/appointment"
						...
						<div class="form-row">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="category"
									id="cat1" value="Infant"> <label
									class="form-check-label" for="cat1">Infant</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="category"
									id="cat2" value="Children"> <label
									class="form-check-label" for="cat2">Children</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="category"
									id="cat3" value="Adolescents"> <label
									class="form-check-label" for="cat3">Adolescent</label>
							</div>
						</div>
						<div class="form-row">
							<input type="text" class="form-control" id="patientname"
								name="name" placeholder="Patient Name" required>
						</div>
						<div class="form-row">
						...
						<div class="form-row">
							<textarea placeholder="Condition" class="form-control"
								id="concern" name="msg" rows="3" required></textarea>
						</div>
						<div class="form-row">
						...
						<div class="form-row">
							<input type="text" class="form-control" id="guardian"
								name="guardian" placeholder="Guardian's Fullname" required>
						</div>
						<div class="form-row">
							<input type="text" class="form-control" id="relation"
								name="relation" placeholder="Relationship" required>
						</div>
						<center>
