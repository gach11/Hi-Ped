...
<body>
	<div class="container-fluid">
		<div class="container">
			<div class="row">
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 signup_section">
					<form action="sendEmail" enctype="multipart/form-data"
						...
						<div class="form-row">
							<textarea rows="10" cols="5" class="form-control" name="content"
								id="content" style="height: 150px text-align:;"
								placeholder="Message" required>Message</textarea>
						</div>
			...
			<script>
	function myFunction() {
		document.getElementById("content").value = "http://localhost:8080/hi_ped_website/send-email.jsp";
	}
</script>
