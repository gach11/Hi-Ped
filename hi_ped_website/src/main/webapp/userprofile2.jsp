...
<body>
	...
	<div class="container-xl px-4 mt-4">
		...
		<nav
			...
			<a class="nav-link" href="userprofile.jsp">User Profile</a> <a
				class="nav-link active ms-0" href="#">History Appointment</a> <a
			...
			<div class="card-body p-0">
				...
				<div class="table-responsive table-billing-history">
					<table class="table mb-0">
						<thead>
							<tr>
								<th style="text-align: center" class="border-gray-200"
									scope="col">Patient Name</th>
								<th style="text-align: center" class="border-gray-200"
									scope="col">Concern</th>
								<th style="text-align: center" class="border-gray-200"
									scope="col">Date and Time</th>
								<th style="text-align: center" class="border-gray-200"
									scope="col">Status</th>
							</tr>
						</thead>
